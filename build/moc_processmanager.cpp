...
#include <memory>
#include "../ESCA/src/modules/aiprocess/processmanager.h"
...
QT_MOC_LITERAL(1, 15, 20), // "handleStandardOutput"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 21), // "handleProcessFinished"
QT_MOC_LITERAL(4, 59, 8), // "exitCode"
QT_MOC_LITERAL(5, 68, 20), // "QProcess::ExitStatus"
QT_MOC_LITERAL(6, 89, 10) // "exitStatus"

    },
    "ProcessManager\0handleStandardOutput\0"
    "\0handleProcessFinished\0exitCode\0"
...
void ProcessManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handleStandardOutput(); break;
        case 1: _t->handleProcessFinished((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QProcess::ExitStatus(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject ProcessManager::staticMetaObject = { {
    QMetaObject::SuperData::link<InferenceEngine::staticMetaObject>(),
...
void *ProcessManager::qt_metacast(const char *_clname)
{
    ...
    return InferenceEngine::qt_metacast(_clname);
}

int ProcessManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = InferenceEngine::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
