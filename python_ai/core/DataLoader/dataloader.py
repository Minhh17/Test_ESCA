...
class Dataloader(Feature_extractor):
    def __init__(self, cfg):
        ...
        self.src_data_dir = {
            ...
            'normal': cfg.get('DATASET.PATH.NORMAL'),
            # 'anomaly':  cfg.DATASET.PATH.ANOMALY,
            'anomaly': cfg.get('DATASET.PATH.ANOMALY'),
        }
        # self.test_data_dir = cfg.DATASET.PATH.TEST
        self.test_data_dir = cfg.get('DATASET.PATH.TEST')
        ...
        self.train_data_ratio = cfg.get('DATASET.RATIO.TRAIN')
        # self.test_data_ratio = cfg.DATASET.RATIO.TEST
        self.test_data_ratio = cfg.get('DATASET.RATIO.TEST')

        # parameters for creating dataloader
        # self.batch_size = cfg.DATASET.DATALOADER.BATCH_SIZE
        self.batch_size = cfg.get('DATASET.DATALOADER.BATCH_SIZE')
        # self.shuffle = cfg.DATASET.DATALOADER.SHUFFLE
        self.shuffle = cfg.get('DATASET.DATALOADER.SHUFFLE')
